...
public final class Keyspaces {
	...
	{
		System.out.println("Keyspace probably doesn't exist, tryping to create it" );
		...
		followers.setKeyspaceName("OMC");
		followees.setKeyspaceName("OMC");
		alltweets.setKeyspaceName("OMC");
		usertweets.setKeyspaceName("OMC");
		atreplies.setKeyspaceName("OMC");
		likes.setKeyspaceName("OMC");
